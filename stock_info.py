...
def stock_info_cjzc_em(timeout: int = 60) -> pd.DataFrame:
    """
    东方财富-财经早餐
    https://stock.eastmoney.com/a/czpnc.html
    :return: 财经早餐
...
def stock_info_global_em(timeout: int = 60) -> pd.DataFrame:
    """
    东方财富-全球财经快讯
...
def stock_info_global_sina(timeout: int = 60) -> pd.DataFrame:
    """
    新浪财经-全球财经快讯
...
def stock_info_global_futu(timeout: int = 60) -> pd.DataFrame:
    """
    富途牛牛-快讯
...
def stock_info_global_ths(timeout: int = 60) -> pd.DataFrame:
    """
    同花顺财经-全球财经直播
